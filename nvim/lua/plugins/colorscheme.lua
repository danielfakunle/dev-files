...
if vim.g.transparent then
  vim.api.nvim_create_augroup("color.bg_clean", { clear = true })
  vim.api.nvim_create_autocmd({ "ColorScheme" }, {
    group = "color.bg_clean",
    pattern = "*",
    callback = function()
...
local sync_term_bg_group = vim.api.nvim_create_augroup("color.sync_term_bg", { clear = true })
